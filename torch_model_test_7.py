...
# 数据集文件夹位置
filepath = "D:/学习/大创/data/训练数据集/data/melspec(32k)(Track1+coughvid)"
...
for train_val_both, test_index in kf.split(data_0):
    ...
    net = ResNet_attention.resnet18(num_classes=2)
    # 加载预训练权重
    ...
    optimizer = optim.Adam(net.parameters(), lr=learning_rate, weight_decay=1.5e-2)
