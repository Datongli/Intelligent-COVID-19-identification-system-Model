...
data_x[0] = sorted(random.sample(data_x[0], data_x_num))
data_x[1] = sorted(random.sample(data_x[1], data_x_num))
data_x[2] = sorted(random.sample(data_x[2], data_x_num))
data_x[3] = sorted(random.sample(data_x[3], data_x_num))
data_x[4] = sorted(random.sample(data_x[4], data_x_num))
...
data_y[0] = sorted(random.sample(data_y[0], data_y_num))
data_y[1] = sorted(random.sample(data_y[1], data_y_num))
data_y[2] = sorted(random.sample(data_y[2], data_y_num))
data_y[3] = sorted(random.sample(data_y[3], data_y_num))
data_y[4] = sorted(random.sample(data_y[4], data_y_num))
