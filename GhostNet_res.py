...
class Bottleneck_small(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, s=4, d=3):
        ...
        super().__init__()
        self.conv1 = GhostModule(inplanes, planes, kernel_size=3, dw_size=d, ratio=s, bias=False, padding=1)
        self.conv2 = GhostModule(planes, planes, kernel_size=3, dw_size=d, ratio=s,
                                 stride=stride, padding=1, bias=False)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
...
def resnet18(num_classes=2):
    ...
    """
    return ResNet(Bottleneck_small, [2, 2, 2, 2], num_classes=num_classes)
...
def resnet34(num_classes=2):
    ...
    Constructs a ResNet-18 model.
    """
    return ResNet(Bottleneck_small, [3, 4, 6, 3], num_classes=num_classes)
